...
- **[Synacor VM Emulator](https://github.com/waaberi/VM_Challenge_In_Python)** - Python implementation of a virtual machine emulator for the Synacor Challenge architecture
- **[MyosAI](https://github.com/waaberi/MyosAI)** - Interactive story builder using GenAI (Gemini API) with self-healing JSON output and branching narrative paths. [Live demo](https://myos-ai.vercel.app/)
...
- **Email:** [wibra007@uottawa.ca](mailto:wibra007@uottawa.ca)
